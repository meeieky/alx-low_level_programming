 ...
 * Description: id the file is not an Elf file - exit code 98.
 */
 ...
 * Description: They are separated by spaces
 */
...
/**
 * print_osabi - Prints the OSABI of an ELF hearder file
 * @e_ident: A pointer to an array containing the ELF version.
 */
...
/**
 * main - Shows information from beginning of a header file
